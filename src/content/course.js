...
const unitDemo = {
  ...
  learn: {
    chunks: [
      {
        id: 'l1', type: 'hook',
        text: 'סופרמרקט בדנמרק לא פותח את הדלת אלא אם כן אתה/ן מחייך/ת.',
        subtext: 'לא בדיחה. מצלמה + AI זיהוי פנים = דלת חכמה. אבל מה קורה ביום גרוע שלא מחייכים?',
        buttonLabel: 'איך זה בנוי? ←',
      },
      {
        id: 'l2', type: 'concept',
        heading: 'שלושה צעדים לכל מודל AI',
        bullets: [
          '📸 אסוף נתוני אימון — אלפי תמונות: פנים מחייכות ולא מחייכות, מכל גיל ועור',
          '🧠 אמן מודל — AI מחפש: מה ההבדל בין חיוך לפנים נייטרלי?',
          '🚪 הפעל — כל מבקר/ת: מצלמה → מודל → דלת נפתחת/נסגרת',
        ],
        subtext: 'המודל לא "רואה" חיוך — הוא מזהה דפוסים בפיקסלים. כ-200,000 פרמטרים שהשתנו באימון.',
        buttonLabel: 'מתי זה נכשל? ←',
      },
      {
        id: 'l3', type: 'comparison',
    ...
    observations: [
      {
        ...
        reveal: 'המודל אומן על תמונות של פנים מחייכות ולא מחייכות מאלפי אנשים. הצלחה: חיוך ברור בתאורה טובה. כישלון: מסכות, חיוך מוסתר, תאורה חלשה, פנים שלא מופיעות בנתוני האימון. המשימה הצרה "חיוך/לא חיוך" היא בדיוק מה שאפשר ל-AI לעשות — לא "האם הם שמחים?". ',
      },
      {
        id: 's2',
