...
const unitDemo = {
  ...
  learn: {
    chunks: [
      {
        id: 'l1', type: 'hook',
        text: 'מאפה או כלבלב? AI ראה אלפי תמונות — ועדיין מתבלבל.',
        subtext: 'הוא לא רואה "כלבלב" — הוא רואה חום + עגול + כתמים כהות. כשמאפה נראה אותו דבר, הוא לא יודע להבדיל.',
        buttonLabel: 'למה זה קורה? ←',
      },
      {
        id: 'l2', type: 'concept',
        ...
        subtext: 'המודל לא "רואה" כלבלב — הוא מזהה דפוסי פיקסלים. הנתונים קובעים מה הוא לומד.',
        buttonLabel: 'מה קורה עם נתונים מוטים? ←',
      },
      {
        id: 'l3', type: 'comparison',
        heading: 'מתי AI מצליח? מתי נכשל?',
        rows: [
          { good: '✅ נתונים מגוונים: גילאים, עורות שונים, תאורות, זוויות', bad: '❌ נתונים מוטים: רק פנים צעירות אירופאיות באור טוב' },
          { good: '✅ משימה בינארית וברורה: חיוך / לא חיוך', bad: '❌ משימה עמומה: "כמה שמח?" — כל אחד מגדיר אחרת' },
          { good: '✅ בדיקה על נתוני אמת לפני פריסה', bad: '❌ בדיקה רק על הנתונים שאומנו עליהם' },
        ],
        buttonLabel: 'בוא נראה את זה ←',
      },
      {
        id: 'l4', type: 'keyterm',
        term: 'Training Data',
